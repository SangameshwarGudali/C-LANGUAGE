...
; Line 35
	lea	rcx, OFFSET FLAT:$SG10535
	call	printf
; Line 36
	lea	rdx, OFFSET FLAT:number
	lea	rcx, OFFSET FLAT:$SG10536
	call	scanf
; Line 38
	mov	edx, DWORD PTR number
	lea	rcx, OFFSET FLAT:$SG10537
	call	printf
; Line 39
	lea	rax, OFFSET FLAT:number
	mov	QWORD PTR memory_address, rax
; Line 41
	mov	r8, QWORD PTR memory_address
	mov	edx, DWORD PTR number
	lea	rcx, OFFSET FLAT:$SG10538
	call	printf
; Line 43
	xor	ecx, ecx
	call	exit
